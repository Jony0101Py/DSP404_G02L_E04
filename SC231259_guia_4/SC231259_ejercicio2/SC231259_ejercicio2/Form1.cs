...
namespace SC231259_ejercicio2
{
    public partial class frmGuia04ejerc2 : Form
    {
        ...
        {
            // Inicializa el contador de ventas a 0
            contaventas = 0;

            // Llama a la función que inicializa los controles
        ...
        public void inicializarControles() {
            ...
            dateTimePicker1.MaxDate = DateTime.ParseExact("31/12/2015", "dd/MM/yyyy", null);
            dateTimePicker1.MinDate = DateTime.ParseExact("01/01/2014", "dd/MM/yyyy", null);
