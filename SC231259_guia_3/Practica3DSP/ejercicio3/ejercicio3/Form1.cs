...
namespace ejercicio3
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            palabras.Add("Pera", "Fruta comestible que procede del Pyrus communis, un árbol que se conoce coloquialmente como peral común.Existen, de todas maneras, muchas clases de peras, que sonproducidas por otros árboles del género Pyrus.");
